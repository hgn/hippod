...
hippoD.controller("Item_specificCntrl", function ($scope, $stateParams, $window, DBService_concrete, HippodDataServiceConcrete) {
...
// function updateSubcontainers(res) {
//     angular.forEach(res)
// }

HippodDataServiceConcrete.getAchievementsConcrete($scope.id, $scope.sub_id).then(function(res) {
...
DBService_concrete.getFooConcrete($scope.id, $scope.sub_id).then(function(res) {
    $scope.data = res;
